...
# 模型权重需要在这里下载：https://github.com/ymcui/Chinese-BERT-wwm
...
# 加载数据集，自己构建目录，wget https://github.com/bojone/bert4keras/blob/master/examples/datasets/sentiment.zip下载数据集
